...
public class ConnectFourFinal{
    ...
    */
     ...
     for(int i=0; i<=tableau.length-4; i++) {
    	 for(int j=0; j<=tableau[0].length-4; j++) {
    		 
    		 for(int x=0; x<4; x++) {
    			 if(tableau[i+x][j+x]=="X") { 
    				 Xcount++;
    				 Ocount=0;
    			 }else if(tableau[i+x][j+x]=="O") {
    				 Ocount++;
    				 Xcount=0;
    			 }else {
    				 Xcount=0; 
     ...
     for(int i=tableau.length-1; i>=3; i--) {
    	 for(int j=0; j<=tableau[0].length-4; j++) {
